        ...
        (lambda (el) 
                (if (org-element-contents el)
                    ...
                    (if (org-element-property :K el)
                        (thread-last results
                            (cons (a4b-org-element-map (org-element-contents el) results))
                  ...
                  (thread-last results
                    (cons (org-element-property :F el))
                    (cons (org-element-property :K el))))
                ) nil nil '(headline)))
...
#+RESULTS: doom-keymap
#+BEGIN_SRC emacs-lisp
((("M-!" "spacemacs/buffer-alternate" map!)
  (nil nil map!)
  (("tab" "spacemacs/buffer-alternate" map!))
  (nil nil map!)))
#+END_SRC
...
(map!
 ...
 (:leader
   ...
   (:desc "buffer" :prefix "b"
     ...
     :desc "Switch workspace buffer" :n "b" #'spacemacs/persp-helm-mini
