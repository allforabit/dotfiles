...
#+RESULTS:
| :recipe | (fakecygpty :fetcher github :repo d5884/fakecygpty :files (*)) |
...
;; Make js2 default to 2 spaces
(setq js2-basic-offset 2)
#+END_SRC

#+RESULTS: config-indium
: 2
...
| :name | React sandbox            | :command | webpack-dev-server                                                                   | :args | (watch) | :cwd         | c:/Users/admin/Documents/Bitbucket/org/code/js/react                      | :tags                        | (play) | :stop-signal | sigkill | :kill-process-buffer-on-stop | t |
