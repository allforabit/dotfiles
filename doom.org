...
* NB deprecated
** Using emacs lisp directly instead of through org mode
* Introduction
...
| :name | Elephant brain           | :command | yarn                                                                                 | :args | (run start) | :cwd         | ~/Documents/GitHub/elephantbrain/                                         | :tags                        | (personal) | :stop-signal | sigkill | :kill-process-buffer-on-stop | t |
...
| :name | Plein Air                | :command | yarn                                                                                 | :args | (run start) | :cwd         | ~/Documents/Github/plein-air/wp-content/themes/plein-air                  | :tags                        | (work)     | :stop-signal | sigkill | :kill-process-buffer-on-stop | t |
