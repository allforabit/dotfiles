        ...
        (skewer-eval full-body (lambda (result)
                                 (let ((value))
                                   ...
                                   (org-babel-insert-result
                                    (alist-get 'value result)))) :type "eval")
        nil)
...
(setq a4b-thing '((id . "6c08260711072da") (type . "eval") (status . "success") (value . "hello") (strict) (time . 1.701)))

(alist-get 'value a4b-thing)
...
(map! (:map input-decode-map
      ...
      (:map tabulated-list-mode-map
        [remap evil-record-macro] #'popup/close-maybe)
